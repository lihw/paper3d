...
"        <exec executable=\"${env.FIPAPER3D}/tools/bin/msvc2012/archiver.exe\" output=\"archiver.txt\" failonerror=\"true\">\n"
"            <arg value=\"-o\" />\n"
"            <arg value=\"${asset.absolute.dir}/../../../../application/res/${ant.project.name}.par\" />\n"
"            <arg value=\"${asset.absolute.dir}/../../../../application/res\" />\n"
"        </exec>\n"
